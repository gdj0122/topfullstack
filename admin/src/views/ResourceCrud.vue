<template>
  <div>
    <avue-crud v-if="option.column" :page.sync="page" :data="data.data" :option="option" @row-save="create" @row-update="update" @row-del="remove" @on-load="changePage" @sort-change="changeSort" @search-change="search" v-model="obj" :upload-before="uploadBefore"></avue-crud>
